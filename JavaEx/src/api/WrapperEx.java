...
//		b2 = null;		<< 허용 안함
		...
		// 주의 : valueOf 내부의 문자열 인자의 형태가 해당 데이터 타입으로 변환할 수 있는 형대여야 함
		...
		Float f2 = 3.14159f;		// 자동 박싱이 되어 객체화됨
		...
		// 언박싱 비교 2번쨰 -> 자동 언박싱 되지 않음 다른 메모리를 차지하기 때문
		System.out.println("i와 i2가 같은가? : " + (i == i2));
		System.out.println("i와 i2의 값이 같은가?(intValue) :	" + (i.intValue() == i2.intValue()));
		
		// equals를 이용한 값의 비교
		System.out.println("i와 i2의 값이 같은가?(equals) : " + i.equals(i2));
	}
}
