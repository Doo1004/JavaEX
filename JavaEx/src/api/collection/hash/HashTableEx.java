...
public class HashTableEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("MAP : " + map);			// 순서가 없음
		
		// 데이터 가져오기 : get
		System.out.println("303 강의실의 강의 : " + map.get("303"));
		...
		System.out.println("Java 강의가 포함되어 있는가?" + map.containsValue(new Classroom("Java")));
		// hashCode, equals가 적절히 오버라이드되어 있어야 정상 작동
