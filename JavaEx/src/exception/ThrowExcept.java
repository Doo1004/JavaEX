...
public class ThrowExcept {
	...
	public void executeUncheckedException() throws RuntimeException{
		...
		throw new RuntimeException("강제 RumtimeException");
	}
	...
	public double divide(int num1, int num2) {
		...
		try {
			...
			// 일반적 예외 발생 시 보다 구체적인 사용자 정의 예외로 전환하여 throw하는 것이 가독성, 코드 디버그 작업에서 유리
			throw new CuntomArithmeticException("사용자 정의 예외", num1, num2);
		}
